...
import styles from '../styles/uic.module.css';
                ...
                <main>
                        ...
                        <span className='BigButtons'>
                            <a
                                className={`${styles.IndexSwitch} ${
                                    this.state.sectionExpanded ? styles.On : styles.Off
                                }`}
                            ...
                            <a
                                className={`${styles.IndexSwitch} ${
                                    this.state.indexExpanded ? styles.On : styles.Off
                                }`}
                    ...
                    <div
                        className={`${styles.Index} ${
                            this.state.indexExpanded ? 'Expended' : styles.Fold
                        }`}
                    ...
                    <div
                        className={`${styles.Index} ${
                            this.state.sectionExpanded ? 'Expended' : styles.Fold
                        }`}
...
export default function UICWrapper(params: UICParams) {
    ...
    const props: UICProps = {
        ...
        section: router.query.section as string | undefined
    };
